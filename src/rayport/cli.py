...
def main():
    ...
    build_parser.add_argument("--width", "-W", type=int, default=None, help="Canvas width (default: fullscreen)")
    build_parser.add_argument("--height", "-H", type=int, default=None, help="Canvas height (default: fullscreen)")
    ...
    dev_parser.add_argument("--width", "-W", type=int, default=None, help="Canvas width (default: fullscreen)")
    dev_parser.add_argument("--height", "-H", type=int, default=None, help="Canvas height (default: fullscreen)")
